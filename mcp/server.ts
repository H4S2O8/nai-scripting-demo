/**
 * NovelAI image generation as an MCP server.
 *
 ...
 * This wraps that same builder in a stdio MCP server so any MCP client can
 * generate images with exactly the payload the phone app sends.
 *
